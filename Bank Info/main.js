...
function submitCode() {
    ...
    fetch(url)
        ...
        .then(function(bankDes) { // On Success
            M.toast({ html: '<i class="material-icons">check</i> Request Successful!', classes: 'green rounded' });
        ...
        .catch(function(error) { // On failure
            M.toast({ html: '<i class="material-icons">close</i>Error Occurred!', classes: 'red rounded' });
